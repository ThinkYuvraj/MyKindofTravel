  ...
  return (
    <section id="radar" className="py-16 bg-[#F5EFEB] dark:bg-[#0E0A08] text-[#2A1810] dark:text-white border-y border-[#EADFD5] dark:border-white/10 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-2">
            {ROUTES.map((route) => (
              <button
                ...
                className={`px-3.5 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 shadow-xs backdrop-blur-md ${
        ...
        <div className="rounded-3xl backdrop-blur-xl bg-white/85 dark:bg-[#16100D]/85 border border-white/80 dark:border-white/10 p-6 sm:p-8 shadow-[0_12px_40px_rgba(42,24,16,0.06)] dark:shadow-[0_12px_40px_rgba(0,0,0,0.4)] relative overflow-hidden">
          {/* Animated Flight Arc Line */}
          <div className="relative py-4 mb-6">
            <div className="flex items-center justify-between relative z-10">
              {/* Origin */}
              <div className="space-y-1">
                <span className="text-[10px] uppercase font-bold tracking-widest text-[#8C5528] dark:text-[#E28C38] block">
                  Departure Hub
                </span>
                <span className="font-serif text-2xl sm:text-4xl font-bold text-[#2A1810] dark:text-white tracking-tight">
                  {currentRoute.originCode}
                </span>
                <span className="text-xs text-[#7C685B] dark:text-neutral-400 block font-medium">
                  {currentRoute.origin}
                </span>
              </div>

              {/* Animated Flight Path Center Graphic */}
              <div className="flex-1 px-4 sm:px-12 flex flex-col items-center">
                <div className="w-full relative flex items-center justify-center">
                  <div className="w-full h-0.5 border-t-2 border-dashed border-[#8C5528]/40 dark:border-[#E28C38]/40" />
                  <div className="absolute p-2.5 rounded-full bg-white dark:bg-[#1A1310] border-2 border-[#8C5528] dark:border-[#E28C38] text-[#8C5528] dark:text-[#E28C38] shadow-md shadow-[#8C5528]/20 -rotate-45 animate-pulse">
                    <Plane className="w-4 h-4" />
                  </div>
                </div>

                <div className="flex items-center gap-2 mt-3 text-[11px] font-bold text-[#8C5528] dark:text-[#E28C38]">
